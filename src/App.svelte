		...
		<div class="row">
		  ...
		  <div class="col-md-2 form-group">
			...
			<div class="col-md-3 form-group">
				...
				<label for="" class="form-label">Pasaporte vigente?</label>
							<input
			...
			<div class="col-md-4 form-group">
				...
				<label for="" class="form-label">Esquema de vacunacion</label>
				<input
				...
				<tbody>
					{#each personas as persona}
						<tr>
							...
							<td>
								<a
								href="http://mexicanlabor.com/workers?federal_id={persona.dpi}&oid=5011661&owid=186117" target="_blank">gestionar</a
								>
